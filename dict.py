...
names = {
	...
	"Want.To.Know":re.compile(r"그것이 알고 싶다"),
	...
	"EBS.Docu.Prime":re.compile(r"EBS 다큐\s?프라임"),
	...
	"No.More.Show":re.compile(r"지상렬의 노모쇼"),
...
#	"Three.Days":re.compile(r"쓰리데이즈"),
	...
	"She.was.Pretty":re.compile(r"그녀는 예뻤다"),
...
#	"Saturday.Freedom.Immortal.Music":re.compile(r"불후의 명곡 전설을 노래하다"),
	...
	"My.Little.Television":re.compile(r"마이\s*리틀\s*텔(레|리)비전|마리텔|MLT-11( -)?"),
